...
public class PlayerTest {
    ...
    public void testAddCardHandSize(){
        try {
    ...
    public void testAddCardMovePreferredCard(){
        try {
    ...
    public void testAddCardOnFullHand(){
        try{
            player.addCard(new Card(2));
            player.addCard(new Card(3));
            player.addCard(new Card(4));
    ...
    public void testRemoveCardHandSize() {
        try {
            player.addCard(new Card(3));
            player.addCard(new Card(3));
            player.addCard(new Card(4));
    ...
    public void testRemoveCardOnNotFullHand(){
        try{
            player.addCard(new Card(2));
            player.removeCard();
    ...
    public void testRemoveCardWithWinningHand(){
    ...
    public void testCheckIfWonTrue(){
        for(int i=0;i<4;i++){
            try {
                player.addCard(new Card(1));
            } catch(Exception e){
    ...
    public void testCheckIfWonFalse(){
        for(int i=0;i<4;i++){
            try{
    ...
    public void testWriteMoveToFileCorrectOutput(){
        try{
            player.addCard(new Card(3));
            player.addCard(new Card(5));
